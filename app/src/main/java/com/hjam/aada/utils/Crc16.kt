...
/**
 * This class is implemented to calculate CRC32-CCIT checksum. (Poly = '0x1021', Init = '0x1D0F')
 * This code is partially based on https://github.com/quickbirdstudios/crc-kotlin
 */
...
class Crc16 {
    ...
    companion object {
        ...
        private fun UByte.toBigEndianUShort(): UShort = this.toUShort() shl 8
        private val lookupTable: List<UShort> =
            listOf(
        ...
        private fun crc16(inputs: UByteArray, initialValue: UShort = (0x1D0F).toUShort()): UShort {
